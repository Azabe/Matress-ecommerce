...
<head>
    ...
    <title>DISTRICTS WITH THE MOST ORDERS</title>
</head>
<style>
...
<body>
    ...
    <div>
        <h2 style="text-align: center">DISTRICTS WITH THE MOST ORDERS REPORT</h2>
    ...
    <tbody>
        ...
        @foreach ($tableData as $row)
            <tr>
                ...
                <td>
                    {{ number_format(($row['order_count'] / $totalQuantity) * 100, 2) }}%
                </td>
            </tr>
        @endforeach
        <tr>
